...
public class ItemControllerTest {
    ...
    @Before
    public void before() {
        WarehouseControllerTest d = new WarehouseControllerTest();
        d.deleteAll();
        d.create("Warehouse");
        try {
    ...
    public void updateItem() {
        ...
        try {
            ...
            URL url = new URL(BASE + String.format(name + "/update?name=Update&id=" + key + "&warehouse=" + RelKey+"&stock=2"));
    ...
    public void createItem() {
        ...
        try {
            ...
            stock = getAll().getJSONObject(0).getInt("c_STOCK");
        } catch (Exception e) {
            assertTrue(false);
        }


        assertTrue(json.length() == 2 && key.equals(RelKey) && stock ==1);
    }
    ...
    public void create(String name) {
        try {
            URL url = new URL(BASE + String.format(this.name+"/create?name=" + name + "&stock=1&warehouse=" + RelKey));
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
            conn.setRequestProperty("Accept", "application/json");
